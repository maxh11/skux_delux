...
# Final weights from td leaf lambda with lambda = 0
w1 = 5
w2 = 0.1
w3 = 0.1
...
def heuristic(colour, state):
    ...
    if colour == WHITE:
        ...
        return state.total_white() - state.total_black()
    ...
    if colour == BLACK:
        ...
        return state.total_black() - state.total_white()
